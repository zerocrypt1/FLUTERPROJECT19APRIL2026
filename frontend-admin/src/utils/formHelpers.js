 ...
 * ✅ FIXED: Changed "aadhaar" to "aadhar" to match backend schema
 */
export const idProofOptions = [
  { value: "aadhar", label: "Aadhar Card" },      // ✅ FIX: aadhar (not aadhaar)
 ...
 * @param {string} idType - The type of ID (e.g., 'aadhar', 'pan').
...
export const validateIdProofNumber = (idType, idNumber) => {
  ...
  switch (idType) {
    case 'aadhar': // ✅ FIX: Updated from 'aadhaar' to 'aadhar'
      // 12 digits
